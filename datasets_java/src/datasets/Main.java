...
public class Main {
	...
	//	public static int sizeMyPage = 50000;
	//	public static int sizeFriends = 5000000;
	//	public static int sizeAccessLog = 10000000;
	public static int sizeMyPage = 5;
	public static int sizeFriends = 50;
	public static int sizeAccessLog = 100;
